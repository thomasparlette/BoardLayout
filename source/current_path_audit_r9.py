...
(p/'reports/Current_path_audit_R9.json').write_text(json.dumps({'status':'NOT AMPACITY QUALIFIED. Width targets are not current ratings; neckdowns, via arrays, copper stackup, duty cycles and heating remain to be engineered.','nets':stats},indent=2))
